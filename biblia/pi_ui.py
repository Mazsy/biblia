...
#
# Created: Wed Dec 21 00:38:23 2016
...
class Ui_NuevaVida(object):
    def setupUi(self, NuevaVida):
        ...
        self.btn_Cargar.setStyleSheet("font-size: 14px; color: #A0184B;")
    ...
    def retranslateUi(self, NuevaVida):
        NuevaVida.setWindowTitle(_translate("NuevaVida", "Palabra viva - Iglesia Nueva Vida", None))
...
if __name__ == "__main__":
    ...
    NuevaVida = QtGui.QMainWindow()
    ui = Ui_NuevaVida()
    ui.setupUi(NuevaVida)
    NuevaVida.show()
    sys.exit(app.exec_())
